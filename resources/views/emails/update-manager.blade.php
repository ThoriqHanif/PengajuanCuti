                      ...
                      "
                            ...
                            ">
                              ...
                              ">
                                    ...
                                    ">
                                                                    @if ($leave->status_manager == 2)
                                                                        <p style="margin: 0; word-break: break-word">
                                                                            Pengajuan cuti Anda dengan kode
                                                                            <span class="badge" style="background-color: rgb(80,107,236); text-transform: capitalize;">#{{ $leave->code }}</span> telah <span class="badge" style="background-color: #22c55e; text-transform: capitalize;">disetujui</span>
                                                                             oleh {{ $managerName }} ({{ $leave->user->manager->position->name }}).
                                                                            Silahkan menunggu persetujuan berikutnya dari Kepala Operasional.
                                                                        </p>
                                                                    @elseif ($leave->status_manager == 3)
                                                                        <p style="margin: 0; word-break: break-word">
                                                                            Pengajuan cuti Anda dengan kode
                                                                            <span class="badge" style="background-color: rgb(80,107,236); text-transform: capitalize;">#{{ $leave->code }}</span> telah <span class="badge" style="background-color: #c42121; text-transform: capitalize;">ditolak</span>
                                                                             oleh {{ $managerName }} ({{ $leave->user->manager->position->name }}).
                                                                        </p>
                                                                    @endif
                                                                </div>
