                      ...
                      "
                            ...
                            ">
                              ...
                              ">
                                    ...
                                    ">
                                                                    @if ($leave->status_coo == 2)
                                                                        <p style="margin: 0; word-break: break-word">
                                                                            Selamat, Pengajuan cuti Anda dengan kode
                                                                            <span class="badge" style="background-color: rgb(80,107,236); text-transform: capitalize;">#{{ $leave->code }}</span> telah <span class="badge" style="background-color: #22c55e; text-transform: capitalize;">disetujui</span>
                                                                             oleh {{ $cooName }} ({{ $leave->user->coo->position->name }}).
                                                                            Terimakasih telah mengajukan Pengajuan Cuti
                                                                        </p>
                                                                    @elseif ($leave->status_coo == 3)
                                                                        <p style="margin: 0; word-break: break-word">
                                                                            Mohon maaf, Pengajuan cuti Anda dengan kode
