                      ...
                      "
                            ...
                            ">
                              ...
                              ">
                                    ...
                                    ">
                                                                    <p style="margin: 0; word-break: break-word">
                                                                        <strong>{{ $managerName }} </strong>telah
                                                                        menyetujui pengajuan cuti dengan <span
                                                                            class="badge"
                                                                            style="background-color: rgb(80,107,236); text-transform: capitalize;">#{{ $leave->code }}</span>
                                                                        dan menunggu persetujuan dari anda.
                                                                    </p>
                                                                </div>
                                                            </td>
                                                        </tr>
