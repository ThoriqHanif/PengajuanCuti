                      ...
                      "
                            ...
                            ">
                              ...
                              ">
                                    ...
                                    ">
                                                                    <p style="margin: 0; word-break: break-word">
                                                                        <strong><span>Permohonan Cuti</span></strong>
                                                                    </p>
                                                                </div>
                                                            </td>
                                                        </tr>
                              ...
                              ">
                                    ...
                                    ">
                                                                    <p style="margin: 0; word-break: break-word">
                                                                        <strong>{{ $leave->user->full_name }}
                                                                        </strong>telah mengajukan cuti dengan code
                                                                        <span class="badge" style="background-color: rgb(80,107,236); text-transform: capitalize;">#{{ $leave->code }}</span> dan
                                                                        menunggu persetujuan dari anda.
                                                                    </p>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                    ...
                                                    <table class="button_block block-4" width="100%" border="0" cellpadding="10" cellspacing="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt;">
														<tr>
															<td class="pad">
																<div class="alignment" align="center"><a href="{{ route('request-leave.show',  ['request_leave' => $leave->id]) }}" target="_blank" style="text-decoration:none;display:inline-block;color:#ffffff;background-color:#6777ef;border-radius:4px;width:auto;border-top:0px solid transparent;font-weight:400;border-right:0px solid transparent;border-bottom:0px solid transparent;border-left:0px solid transparent;padding-top:5px;padding-bottom:5px;font-family:Helvetica Neue, Helvetica, Arial, sans-serif;font-size:16px;text-align:center;mso-border-alt:none;word-break:keep-all;"><span style="padding-left:20px;padding-right:20px;font-size:16px;display:inline-block;letter-spacing:normal;"><span style="word-break: break-word; line-height: 32px;">Lihat Pengajuan</span></span></a><!--[if mso]></center></v:textbox></v:roundrect><![endif]--></div>
															</td>
														</tr>
													</table>
                                                </td>
