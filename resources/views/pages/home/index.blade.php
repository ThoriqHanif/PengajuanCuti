    ...
    <main class="main" id="top">
        <nav class="navbar navbar-expand-lg navbar-light sticky-top" data-navbar-on-scroll="data-navbar-on-scroll">
            <div class="container"><a class="navbar-brand" href="index.html"><img
                        src="{{ asset('landingpage/public/assets/img/utiKita.png') }}" height="31"
                        alt="logo" /></a>
                ...
                <div class="collapse navbar-collapse border-top border-lg-0 mt-4 mt-lg-0" id="navbarSupportedContent">
                    <ul class="navbar-nav ms-auto">
                        ...
                        @if (Auth::check())
                            <div class="d-flex ms-lg-4"><a class="btn btn-primary ms-3"
                                    href="{{ route('dashboard') }}">Dashboard</a></div>
                        @else
                            <div class="d-flex ms-lg-4"><a class="btn btn-primary ms-3" href="{{ route('login') }}">Sign
                                    In</a></div>
                        @endif
            ...
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-md-6 text-md-start text-center py-6">
                        ...
                        <p class="mb-6 lead text-secondary">Pencatatan, Pelacakan dan Saldo Cuti<br
                                class="d-none d-xl-block" />dalam satu sistem yang simpel! Mudahkan karyawanmu sebagai
                            pengguna selanjutnya.</p>
                        <div class="text-center text-md-start"><a class="btn btn-primary me-3 btn-lg"
                                href="{{ route('login') }}" role="button">Get started</a></div>
                    </div>
                    <div class="col-md-6 text-end">
                        <img class="pt-7 pt-md-0 img-fluid floating"
                            src="{{ asset('landingpage/public/assets/img/hero/hero1.png') }}" alt="" />
