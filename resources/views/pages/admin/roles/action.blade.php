    <a class="btn btn-sm bg-primary text-white font-weight-bold text-xs detail-posisi" data-toggle="tooltip"
        data-placement="top" title="Detail Posisi" data-roles-id="{{ $roles->id }}" href="{{route ('roles.show', $roles->id)}}">
...
{{-- @if ($roles->trashed())
    <form style="display: inline" action="{{ route('position.restore', $roles->id) }}" method="POST"
        id="restoreFormroles">
        @csrf
        <button type="submit" class="btn btn-sm btn-info restore-button-roles" data-toggle="tooltip"
            data-placement="top" title="Restore Posisi">
            <i class="fas fa-undo"></i>
        </button>

    </form>
    <form style="display: inline" action="{{ route('position.forceDelete', $roles->id) }}" method="POST"
        id="forceDeleteFormroles">
        @csrf
        @method('DELETE')
        <button type="submit" class="btn btn-sm btn-danger delete-button-roles" data-toggle="tooltip"
