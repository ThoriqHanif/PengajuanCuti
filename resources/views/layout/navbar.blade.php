            ...
            <div class="dropdown-menu dropdown-list dropdown-menu-right">
                ...
                <div class="dropdown-list-content dropdown-list-icons">
                    <a href="#" class="dropdown-item dropdown-item-unread">
                        ...
                        <div class="dropdown-item-desc">
                            Pengajuan <b class="text-info">CTHRQ01</b> sedang direview oleh COO
                            <div class="time text-primary">A Sec Ago</div>
                        </div>
                    </a>
                    <a href="#" class="dropdown-item dropdown-item-unread">
                        ...
                        <div class="dropdown-item-desc">
                            Pengajuan <b class="text-info">CTHRQ01</b> disetujui oleh Manager
                    ...
                    <a href="#" class="dropdown-item dropdown-item-unread">
                        ...
                        <div class="dropdown-item-desc">
                            Pengajuan <b class="text-info">CTHRQ01</b> sedang direview oleh Manager
                    ...
                    <a href="#" class="dropdown-item">
                        ...
                        <div class="dropdown-item-desc">
                            Thoriq Hanif Mengajukan Cuti <span class="text-info">CTHRQ01</span>
