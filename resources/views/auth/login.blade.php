...
<head>
    ...
    {{-- <style>
        .background-walk-y {
            background-image: url('{{asset('assets/img/unsplash/login-bg.jpg')}}');
            background-size: cover; /* Sesuaikan dengan kebutuhan tata letak gambar latar belakang */
                    ...
                    <div
                        ...
                        <div class="login-brand">
                            <img src="{{ asset('assets/img/logo.png') }}" alt="logo" width="100"
                                class="shadow-light rounded-circle pl-2">
                        </div>
                                ...
                                <form action="{{ route('login') }}" method="post" class="mt-2">
                                    @csrf <div class="form-group">
                                        ...
                                        <input id="email" type="email"
                                            ...
                                            tabindex="1" id="email" required autofocus>
                                        @error('email')
